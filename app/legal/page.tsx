              ...
              <>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4 leading-relaxed">
                    ...
                    can disable cookies in your browser settings, though this may affect site
                    functionality.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="leading-relaxed">
                    ...
                    such information and terminate the child&rsquo;s account.
                  </p>
                </section>
            ...
            {activeTab === 'terms' && (
              <>
                ...
                <section className="mb-8">
                  ...
                  <p className="leading-relaxed">
                    Further, can(RE)volution does not warrant or make any representations concerning
                ...
                <section className="mb-8">
                  ...
                  <p className="leading-relaxed">
                    ...
                    on can(RE)volution&rsquo;s website, even if can(RE)volution or an authorized
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4 leading-relaxed">
                    ...
                    link does not imply endorsement by can(RE)volution of the site. Use of any such
                    linked website is at the user&rsquo;s own risk.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="leading-relaxed">
                    ...
                    laws of the jurisdiction in which can(RE)volution operates, and you irrevocably
                ...
                <section className="mb-8">
                  ...
                  <p className="leading-relaxed">
                    ...
                    arising from your use of the website or violation of these terms of service.
                  </p>
                </section>
