                ...
                <>
                  ...
                  <section className="mb-8">
                    ...
                    <p className="mb-4 leading-relaxed">
                      ...
                      for their marketing purposes. We may share your information only in the
                  ...
                  <section className="mb-8">
                    ...
                    <p className="leading-relaxed">
                      ...
                      a child has provided us with personal information, we will take steps to
                      delete such information and terminate the child&rsquo;s account.
                    </p>
                  </section>
                  ...
                  <section className="mb-12">
                    ...
                    <p className="mt-2 text-sm" style={{ color: theme.text.mutedDark }}>
                ...
                <>
                  ...
                  <section className="mb-8">
                    ...
                    <p className="mb-4 leading-relaxed">
                      ...
                      (information or software) on can(RE)volution&rsquo;s website for personal,
                  ...
                  <section className="mb-8">
                    ...
                    <p className="mb-4 leading-relaxed">
                      The materials on can(RE)volution&rsquo;s website are provided on an &quot;as
                      is&quot; basis. can(RE)volution makes no warranties, expressed or implied, and
                    ...
                    <p className="leading-relaxed">
                      Further, can(RE)volution does not warrant or make any representations
                  ...
                  <section className="mb-8">
                    ...
                    <p className="leading-relaxed">
                      In no event shall can(RE)volution or its suppliers be liable for any damages
                      (including, without limitation, damages for loss of data or profit, or due to
                      business interruption) arising out of the use or inability to use the
                      materials on can(RE)volution&rsquo;s website, even if can(RE)volution or an
                  ...
                  <section className="mb-8">
                    ...
                    <p className="mb-4 leading-relaxed">
                      ...
                      technical, typographical, or photographic errors. can(RE)volution does not
                      warrant that any of the materials on its website are accurate, complete, or
                      current. can(RE)volution may make changes to the materials contained on its
                  ...
                  <section className="mb-8">
                    ...
                    <p className="mb-4 leading-relaxed">
                      can(RE)volution has not reviewed all of the sites linked to its website and is
                      not responsible for the contents of any such linked site. The inclusion of any
                      link does not imply endorsement by can(RE)volution of the site. Use of any
                  ...
                  <section className="mb-8">
                    ...
                    <p className="leading-relaxed">
                      can(RE)volution may revise these terms of service for its website at any time
                  ...
                  <section className="mb-8">
                    ...
                    <p className="leading-relaxed">
                      ...
                      the laws of the jurisdiction in which can(RE)volution operates, and you
                  ...
                  <section className="mb-8">
                    ...
                    <p className="mb-4 leading-relaxed">
                      ...
                      software, is the property of can(RE)volution or its content suppliers and is
                      protected by international copyright laws. Any unauthorized reproduction or
                  ...
                  <section className="mb-8">
                    ...
                    <p className="leading-relaxed">
                      can(RE)volution is not responsible for the content, accuracy, or practices of
                      third-party websites linked to or from our site. Your use of third-party
                      websites is at your own risk and subject to their terms of service.
                    </p>
                  </section>
                  ...
                  <section className="mb-8">
                    ...
                    <p className="mb-4 leading-relaxed">
                      To the fullest extent permitted by law, in no event shall can(RE)volution be
                      liable for any indirect, incidental, special, consequential, or punitive
                      damages, regardless of the cause of action or the theory of liability, even if
                      can(RE)volution has been advised of the possibility of such damages.
                    </p>
                  </section>
                  ...
                  <section className="mb-8">
                    ...
                    <p className="leading-relaxed">
                      You agree to indemnify and hold harmless can(RE)volution and its officers,
                      directors, employees, and agents from any claims, damages, losses, and
                      expenses arising from your use of the website or violation of these terms of
                      service.
                    </p>
                  </section>
