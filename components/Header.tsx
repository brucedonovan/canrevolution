      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#0369a1] to-[#06b6d4] opacity-30 sm:left-[calc(50%-30rem)] sm:w-288.75"
          />
        </div>
      </div>
