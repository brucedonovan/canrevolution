...
export default function Header() {
  ...
  return (
    <div className="relative bg-amber-950">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#d97706] to-[#b45309] opacity-40 sm:left-[calc(50%-30rem)] sm:w-288.75"
          />
        </div>
      </div>
