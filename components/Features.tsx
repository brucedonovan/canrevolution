...
const AccordionItem: React.FC<{
  ...
  return (
    <div
      style={{ borderBottomColor: `var(--primary-light, ${theme.primary.light})` }}
      className="border-b"
    >
      <button
        onClick={onToggle}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div>
            ...
            <p style={{ color: theme.text.muted }} className="text-base md:text-lg max-w-2xl">
              ...
              <strong>Can(Re)volution</strong> solutions, your café becomes more than a place to
              grab a drink, it becomes an experience your customers can take anywhere. Here&rsquo;s
              what you can offer:
            </p>
          </div>
